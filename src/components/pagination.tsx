...
export function Pagination({ items, page, pages }: PaginationProps) {
  ...
  return (
    <div className="flex s text-sm items-center justify-end text-zinc-500">
      {!isMobileWindow && <span>Showing 10 of {items} items</span>}
      <div className="flex items-center gap-8">
        {!isMobileWindow && <div className="flex items-center gap-2">
