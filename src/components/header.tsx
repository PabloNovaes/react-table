    ...
    <div className="max-w-[1200px] mx-auto px-4 flex items-center justify-between">
      ...
      {/* <div className="flex items-center gap-3">
        <div className="flex flex-col items-end gap-0.5">
          <span className="text-sm font-medium">Pablo Novaes</span>
          <span className="text-xs text-zinc-400">ppablo.0028922@gmail.com</span>
        </div>
        <img
          src="https://github.com/pablonovaes.png"
